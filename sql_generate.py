...
prompt_input = """Communication Sequence
...
Please use the right column names as defined in the schema. Give me only one result.
...
prompt_input_def = """Communication Sequence
YOU MUST GO THROUGH ALL OF THESE STEPS IN ORDER. DO NOT SKIP ANY STEPS. 
...
Give me only one result with its step by step clear explaination of the query Just in Turkish. 
